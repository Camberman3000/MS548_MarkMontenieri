...
class MainProgram:
    ...
    def task_textblob_sentiment(self):
    ...
    def task_tuple(self, x=None):
        ...
        x = Tuples()
        x.task_child_tuple("Tuple item 1")
...
class Tuples(MainProgram):  # Child class
